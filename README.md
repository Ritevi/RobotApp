...
#### auth/activateProfile POST

* Подтверждение локального профиля

  Название параметра | Описание | Место хранения
  ------------ | ------------- | -------------
  emailUUID | Уникальный идентификатор в сообщении | тело запроса
...
* Удалить робота из своей коллекции

  Название параметра | Описание | Место хранения
  ------------ | ------------- | -------------
  accessToken | jsonWebToken   | заголовок запроса ( authorization )
  id | id робота в системе | строка запроса
